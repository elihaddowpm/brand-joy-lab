...
- **email_findings**: Output 4-5 BJL findings shaped as raw material for an outreach email writer to choose from. Each finding is a numbered item with three parts: (1) the behavioral observation in one sentence, no preamble, no methodology language; (2) the supporting data in parentheses (item name, JI or top_pct, n); (3) a one-sentence outreach implication that tells the email writer what this finding lets them say. Do NOT write the email. Do NOT make the findings rhetorically forceful. Do NOT presume the prospect's situation or critique their current approach. Each finding should read as observational and slightly under-claimed. The email writer will sharpen them in context. Lead with the finding that best matches the prospect's category and signals from any provided context. Avoid findings that depend on the prospect having a particular weakness or gap. Tone: a researcher handing notes to a writer, not a strategist making a pitch.
